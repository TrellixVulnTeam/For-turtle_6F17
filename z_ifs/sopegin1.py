...
def if4(int1, int2, int3):
    ...
    if int1>0 and int2>0 and int3>0:
        return (3)
    elif (int1>0 and int2>0) or (int1>0 and int3>0) or (int2>0 and int3>0):
        return (2)
...
def if13(float1, float2, float3):
    ...
    if float1>float2>float3:
        ...
        return (float1)
    elif float2>float3>float1:
        return (float3)
    elif float3>float1>float2:
        return (float1)
    elif float3>float2>float1:
        return (float2)
    else:
        return (float2)
