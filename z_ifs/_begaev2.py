...
def if22(float1, float2):
    ...
    if float1==0 and float2!=0:
        ...
        return('Точка лежит в первой координатной четверти')
    elif float1<0 and float2>0:
        return('Точка лежит во второй координатной четверти')
    elif float1<0 and float2<0:
        return('Точка лежит в третей координатной четверти')
    elif float1>0 and float2<0:
        return('Точка лежит в четвёртой координатной четверти')
...
def if23(int1, int2, int3, int4, int5, int6):
    ...
    if int4==int6 and int6!=int2:
        int8=int2
    return(f'координаты его четвертой вершины ({int7},{int8})')
...
def if24(x):
    ...
    if x>0:
        ...
        k=6-x
    return('''значения:f(''',x,''')= {2 ∙ sin(x) , если x > 0,
                  6 − x, если x ≤ 0       ,будет равно:''',k)
...
def if25(x):
    ...
    if (x<-2)or(x>2):
        ...
        k=x*-3
    return('''значения:f(''',x,''')= {2 ∙ x , если x < −2 или x > 2,
                  −3 ∙ x, в противном случае       ,будет равно:''',k)
...
def if26(x):
    ...
    if x<=0:
        ...
        k=4
    return('''значения:f(''',x,''')= {−x, если x ≤ 0,
                  x², если 0 < x <2,
                  4, если x ≥ 2,будет равно:''',k)
...
def if27(x):
    ...
    if x<0:
        ...
        k=-1
    return('''значения:f(''',x,''')= {0, если x < 0,
                  1, если x принадлежит [0,1),[2,3), ... ,
                  −1, если x принадлежит [1,2),[3,4), ...,будет равно:''',k)
...
def if28(int1):
    ...
    if int1%100==0 and int1%400 !=0:
        ...
        k=365
    return(f'Kоличество дней в {int1} году будет равно {k}')
