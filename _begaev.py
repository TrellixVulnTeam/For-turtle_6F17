def elif12(number, element):
    ...
    """
    if number==1:
        print('Радиус R =',"{:1.6f}".format(element))
        print('Диаметр D =',"{:1.6f}".format(2*element))
        print('Длина L =',"{:1.6f}".format(2*element*3.14))
        print('Площадь круга S =',"{:1.6f}".format(3.14*element**2))
    elif number==2:
        print('Радиус R =',"{:1.6f}".format(element/2))
        print('Диаметр D =',"{:1.6f}".format(element))
        print('Длина L =',"{:1.6f}".format(element*3.14))
        print('Площадь круга S =',"{:1.6f}".format(3.14*(element/2)**2))
    elif number==3:
        print('Радиус R =',"{:1.6f}".format(element/6.28))
        print('Диаметр D =',"{:1.6f}".format(element/3.14))
        print('Длина L =',"{:1.6f}".format(element))
        print('Площадь круга S =',"{:1.6f}".format(3.14*(element/6.28)**2))
    elif number==4:
        print('Радиус R =',"{:1.6f}".format((element/3.14)**0.5))
        print('Диаметр D =',"{:1.6f}".format(((element/3.14)**0.5)*2))
        print('Длина L =',"{:1.6f}".format(((element/3.14)**0.5)*6.28))
        print('Площадь круга S =',"{:1.6f}".format(element))
    else:
        print('Неверно введён номер')
...
def elif13(number, element):
    ...
    """
    if number==1:
        print('Катет а =',"{:1.6f}".format(element))
        print('Гипотенуза c =',"{:1.6f}".format((element*2**0.5)))
        print('Высота h =',"{:1.6f}".format((element*2**0.5)/2))
        print('Площадь S =',"{:1.6f}".format((element**2)/2))
    elif number==2:
        print('Катет а =',"{:1.6f}".format(element/(2**0.5)))
        print('Гипотенуза c =',"{:1.6f}".format(element))
        print('Высота h =',"{:1.6f}".format(element/2))
        print('Площадь S =',"{:1.6f}".format((element**2)/4))
    elif number==3:
        print('Катет а =',"{:1.6f}".format(element*2/(2**0.5)))
        print('Гипотенуза c =',"{:1.6f}".format(element*2))
        print('Высота h =',"{:1.6f}".format(element))
        print('Площадь S =',"{:1.6f}".format(element**2))
    elif number==4:
        print('Катет а =',"{:1.6f}".format((element*2)**0.5))
        print('Гипотенуза c =',"{:1.6f}".format((element**0.5)*2))
        print('Высота h =',"{:1.6f}".format(element**0.5))
        print('Площадь S =',"{:1.6f}".format(element))
    else:
        print('Неверно введён номер')
...
def elif14(number, element):
    ...
    """
    if number==1:
        print('Сторона а =',"{:1.6f}".format(element))
        print('Радиус вписанной окружности r1 =',"{:1.6f}".format((element*3**0.5)/6))
        print('Радиус r2 описанной окружности =',"{:1.6f}".format((element*3**0.5)/3))
        print('Площадь S =',"{:1.6f}".format(((element**2)*(3**0.5))/4))
    elif number==2:
        print('Сторона а =',"{:1.6f}".format((element*6)/3**0.5))
        print('Радиус вписанной окружности r1 =',"{:1.6f}".format(element))
        print('Радиус r2 описанной окружности =',"{:1.6f}".format(element*2))
        print('Площадь S =',"{:1.6f}".format((element**2)*3*3**0.5))
    elif number==3:
        print('Сторона а =',"{:1.6f}".format((element*3)/3**0.5))
        print('Радиус вписанной окружности r1 =',"{:1.6f}".format(element/2))
        print('Радиус r2 описанной окружности =',"{:1.6f}".format(element))
        print('Площадь S =',"{:1.6f}".format(((element**2)*27**0.5)/4))
    elif number==4:
        print('Сторона а =',"{:1.6f}".format(((element*4)/3**0.5)**0.5))
        print('Радиус вписанной окружности r1 =',"{:1.6f}".format((element**0.5)*3**0.25/3))
        print('Радиус r2 описанной окружности =',"{:1.6f}".format((element**0.5)*3**0.25*2/3))
        print('Площадь S =',"{:1.6f}".format(element))
    else:
        print('Неверно введён номер')
...
def elif15(n, m):
    ...
    if (6 <= n <= 14):
        if (1 <= m <= 4):
            ...
            kart={6: 'шестёрка',7: 'семёрка',8: 'восьмёрка', 9: 'девятка', 10: 'десятка',11: 'валет', 12: 'дама', 13: 'король', 14: 'туз'}
            print(kart[n],mast[m])
        else:
            print('Неверно введено m')
    else:
         print('Неверно введено n, возможно m')
...
def elif19(year):
    ...
    if year%12==4:
        b=1
        print('год',col[a],ani[b])
    elif year%12==5:
        b=2
        print('год',col[a],ani[b])
    elif year%12==6:
        b=3
        print('год',col1[a],ani[b])
    elif year%12==7:
        b=4
        print('год',col1[a],ani[b])
    elif year%12==8:
...
def elif20(day, month):
    ...
    if (month==1) and (0<=day<=31):
        ...
        print('Неверно введена дата')
    if 20<=d<=49:
        print('Знак Зодиака, соответствующий этой дате:',znak[1])
    elif 50<=d<=80:
        print('Знак Зодиака, соответствующий этой дате:',znak[2])
    elif 81<=d<=110:
        print('Знак Зодиака, соответствующий этой дате:',znak[3])
    elif 111<=d<=141:
        print('Знак Зодиака, соответствующий этой дате:',znak[4])
    elif 142<=d<=173:
        print('Знак Зодиака, соответствующий этой дате:',znak[5])
    elif 174<=d<=204:
        print('Знак Зодиака, соответствующий этой дате:',znak[6])
    elif 205<=d<=235:
        print('Знак Зодиака, соответствующий этой дате:',znak[7])
    elif 236<=d<=266:
        print('Знак Зодиака, соответствующий этой дате:',znak[8])
    elif 267<=d<=296:
        print('Знак Зодиака, соответствующий этой дате:',znak[9])
    elif 297<=d<=327:
        print('Знак Зодиака, соответствующий этой дате:',znak[10])
    elif 328<=d<=356:
        print('Знак Зодиака, соответствующий этой дате:',znak[11])
    elif (357<=d<=366) or(0<=d<=19):
        print('Знак Зодиака, соответствующий этой дате:',znak[12])
